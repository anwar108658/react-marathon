...
const BgChanger = () => {
  ...
  return (
    <div className="w-full h-screen bg-black text-white flex justify-center" style={{backgroundColor:color}}>
        <div className="w-full max-w-7xl absolute bottom-0 mb-5 p-2 rounded-lg bg-cyan-950">
            {
